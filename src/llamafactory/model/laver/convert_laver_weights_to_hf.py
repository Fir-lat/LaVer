...
from .configuration_llava import Llava1_5_qwenConfig
from .modeling_llava import LlavaForConditionalGeneration1_5_Qwen
from .processing_llava import Llava1_5_QwenProcessor
...
def convert_llava_llama_to_hf(text_model_id, vision_model_id, vlm_model_id, output_hub_path, old_state_dict_id):
    ...
    model.language_model.load_state_dict(text_model.state_dict(), strict=False)
    model.lm_head.load_state_dict(text_model.lm_head.state_dict(), strict=False)
...
def main():
    ...
    parser.add_argument(
        "--vision_model_id",
        default="/apdcephfs_fslw/share_303787370/firhzli/model/google/siglip2-so400m-patch14-384", #"/apdcephfs_qy4/share_302593112/firhzli/code/clip-vit-large-patch14-336", #"/apdcephfs_fslw/share_303787370/firhzli/model/siglip2-so400m-patch16-256",
    ...
    parser.add_argument(
        "--output_hub_path",
        default="/apdcephfs_jn3/share_303660324/firhzli/model/llava1_5_qwen_2_5_instruct_siglip2", #"/apdcephfs_nj3/share_300377003/firhzli/model/llava1_5_qwen_2_5_instruct_debug",
