...
class LlavaForConditionalGeneration(LlavaPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config: LlavaConfig):
        ...
        # raise Exception(f"stop here {config.text_config}")
        ...
        if pixel_values is not None:
            ...
            if not is_torchdynamo_compiling() and inputs_embeds[special_image_mask].numel() != image_features.numel():
                ...
                if n_image_tokens > n_image_features:
                    image_features = torch.cat([image_features, torch.zeros(n_image_tokens - n_image_features, image_features.shape[1], image_features.shape[2]).to(image_features.device, image_features.dtype)], dim=0)
